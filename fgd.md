...
<br>搜索关键词：<br>`Community detection` `Community detection survey` `community discovery` `Detecting family`  `relationship labeling` `Social Matching` `Behavior Targeting`
<br>
...
###1.5 [CEC: IEEE Congress on Evolutionary Computation (CEC)](http://www.cec2017.org/)
...
* ![](imgs/p.png)`基于通话记录推断用户间关系`<br>Motahari S, Mengshoel O J, Reuther P, et al. The impact of social affinity on phone calling patterns: categorizing social ties from call data records[C]//Proc. of the Sixth Workshop on Social Network Mining and Analysis. 2012.
* ![](imgs/p.png)`通话记录聚类分析`<br>Kurucz M, Benczur A, Csalogány K, et al. Spectral clustering in telephone call graphs[C]//Proceedings of the 9th WebKDD and 1st SNA-KDD 2007 workshop on Web mining and social network analysis. ACM, 2007: 82-91.
 ...
 * `综述（47页）：综述团体发现、评估、实验`<br>Chakraborty T, Dalmia A, Mukherjee A, et al. Metrics for Community Analysis: A Survey[J]. arXiv preprint arXiv:1604.03512, 2016.
