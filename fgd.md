...
* ![](imgs/p.png)`基于通话记录推断用户间关系`<br><span style="background:#f06 !important;">Motahari S, Mengshoel O J, Reuther P, et al. The impact of social affinity on phone calling patterns: categorizing social ties from call data records[C]//Proc. of the Sixth Workshop on Social Network Mining and Analysis. 2012.</span>
